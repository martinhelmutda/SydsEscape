...
public class GameStateReady implements GameState{
	...
	public void pinturitas(Graphics dgb) {
		...
		//Aqu� mostraremos el efecto de selecci�n entre las opciones
		...
		}//Tomamos el n�mero de opciones
	}


	public void keyPressed(int key) {//PODEMOS CAMBIAR A UN SWITCH
		if(key == KeyEvent.VK_DOWN) {
			seleccion++; //Si se presiona alguna de las teclas, la selecci�n cambia
