...
public class GamePanel extends JPanel implements Runnable, KeyListener{
	...
	private Thread animator; // Controla animaci�n
	...
	public void start() {
	 ...
	 public void run() {
		 ...
		 while(corredor) {
			 ...
			 if (espera <= 0) {
				 espera=5;
			 }	//No permitimos que la computadora procese tan r�pido
	 ...
	 public void paintComponent(Graphics dbg) {
		 ...
		 director.pinturitas(dbg); 	//Pintamos las im�genes que el director administra
	 }
