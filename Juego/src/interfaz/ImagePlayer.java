...
public class ImagePlayer {
	...
	private String imName;
	  ...
	  public ImagePlayer(String nm, int ap, double d, 
	                                boolean isr, ImageLoader il) 
	  {
	    ...
	    if (!imgLoader.isLoaded(imName)) {
	      ...
	      numImages = imgLoader.numImages(imName);
	      imPosition = 0;
	      ticksIgnored = false;
	  ...
	  { if (numImages != 0)
	      return imgLoader.getImage(imName, imPosition); 
	    else
	      return null; 
