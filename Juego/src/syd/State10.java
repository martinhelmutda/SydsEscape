...
public class State10 implements SydState{
	Syd context;
	...
	public State10(SpriteSheet ss, Syd syd) {
		this.ss = ss;
		this.context = syd;
		
		image = ss.grabImage(1, 10, 100, 100);
	}
	...
	public void pinturitas(Graphics dbg) {
		...
		if(context.cont%10 == 0){
			if(context.getSuperSyd()){
				...
				image= ss.grabImage(Syd.contador, 10, 100, 100);
			}
		}
