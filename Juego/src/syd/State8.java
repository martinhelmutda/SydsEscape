...
public class State8 implements SydState{
	Syd context;
	...
	public State8(SpriteSheet ss, Syd syd) {
		this.ss = ss;
		this.context = syd;
		
		image = ss.grabImage(1, 8, 100, 100);
	}
	...
	public void pinturitas(Graphics dbg) {
		...
		if(context.cont%10 == 0){
			if(context.getSuperSyd()){
				...
				image= ss.grabImage(Syd.contador, 8, 100, 100);
			}
		}
	...
	@Override
	public void state9() {
		context.setState(context.getState9());
