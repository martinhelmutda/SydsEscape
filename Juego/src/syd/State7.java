...
public class State7 implements SydState{
	Syd context;
	...
	public State7(SpriteSheet ss, Syd syd) {
		this.ss = ss;
		this.context = syd;
		
		image = ss.grabImage(1, 7, 100, 100);
	}
	...
	public void pinturitas(Graphics dbg) {
		...
		if(context.cont%10 == 0){
			if(context.getSuperSyd()){
				...
				image= ss.grabImage(Syd.contador, 7, 100, 100);
			}
		}
	...
	@Override
	public void state8() {
		context.setState(context.getState8());
